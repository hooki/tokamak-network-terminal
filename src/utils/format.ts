 ...
 */
export function formatWeiToToken(
 ...
 * @returns Formatted token amount string
 */
export function formatWeiToTokenPrecise(
  weiAmount: string | bigint,
  decimals: number = 18,
      ...
      if (decimalIndex !== -1) {
        ...
        if (significantIndex !== -1) {
          ...
          const decimalPlaces = Math.min(
            significantIndex - decimalIndex + 2,
            maxDecimals
          );
          return tokenAmount.toLocaleString('en-US', {
            minimumFractionDigits: 0,
 ...
 * @returns Formatted string with token unit
 */
export function formatTokenAmountWithUnitPrecise(
  weiAmount: string | bigint,
  unit: string = 'TON',
  decimals: number = 18,
  maxDecimals: number = 8
...
export const formatTONWithUnit = (
  weiAmount: string | bigint,
  decimals: number = 18
